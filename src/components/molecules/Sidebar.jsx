    ...
    <div className="gx-logo">
      <div className="gx-logo-mark">
        <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
          ...
          <path d="M8.5 12a3.5 3.5 0 1 0 6.3 -2.1l1.7 -1.7l-1.5 -1.5l-1.7 1.7A3.5 3.5 0 0 0 8.5 12z" fill="#fff" />
      ...
      <div className="gx-sidebar-bottom">
        <div className="gx-admin-card">
          <div
            ...
            style={{ width: collapsed ? 32 : 36, height: collapsed ? 32 : 36, fontSize: 13 }}
          >
            {initials}
          </div>
          {!collapsed && (
        ...
        >
          <span className="gx-nav-icon"><IconLogout /></span>
